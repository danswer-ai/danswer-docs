...
You will have to install it in your container by uncommenting `gpt4all==1.0.5` in
**danswer/backend/requirements/default.txt** and rebuilding an image with GPT4All installed.
