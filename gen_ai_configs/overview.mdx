...
**Note:** Most of the different LLM support is provided by the [LiteLLM](https://python.langchain.com/docs/integrations/chat/litellm)
Langchain library and are configured accordingly (see the following sections for some examples).
