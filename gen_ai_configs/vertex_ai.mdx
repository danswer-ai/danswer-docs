...
2. Authenticate with the gcloud CLI using `gcloud auth application-default login` on the machine that Danswer is running on.
...
<div className="flex gap-2">
  <div>
    ![VertexAILLMProvider](/images/gen_ai/vertex_ai/cli-1.png)
  </div>
  <div>
    ![VertexAILLMProvider](/images/gen_ai/vertex_ai/cli-2.png)
  </div>
  <div>
    ![VertexAILLMProvider](/images/gen_ai/vertex_ai/cli-3.png)
  </div>
</div>
...
2. Click `+ Create Service Account` and set one up with a name like `onyx-vertex-ai`. Give it access to the `Vertex AI Service Agent` role. Create!
...
<div className="flex gap-2">
  ...
  <div>
    ![VertexAILLMProvider](/images/gen_ai/vertex_ai/service-acc-3.png)
  </div>
  <div>
    ![VertexAILLMProvider](/images/gen_ai/vertex_ai/cli-3.png)
  </div>
