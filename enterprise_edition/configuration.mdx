...
Endpoint: `POST /chat/test-standard-answer`
...
```bash
curl -X POST 'http://localhost:8080/chat/test-standard-answer' \
...
If you have any questions, feel free to message us at founders@danswer.ai for clarification or join our [Slack](https://join.slack.com/t/danswer/shared_invite/zt-2lcmqw703-071hBuZBfNEOGUsLa5PXvQ) or [Discord](https://discord.gg/TDJ59cGV2X) communities.
