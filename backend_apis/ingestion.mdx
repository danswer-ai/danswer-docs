...
- `source`: Source type, full list can be checked by searching for DocumentSource
  [here](https://github.com/onyx-dot-app/onyx/blob/main/backend/danswer/configs/constants.py)
...
[here](https://github.com/onyx-dot-app/onyx/blob/main/backend/danswer/connectors/models.py),
called "DocumentBase"
