...
3. We recommend at least 16GB of RAM, 4-8vCPU cores, and 500GB of disk. The exact instance type to
   ...
   For more information on sizing, refer to our [resourcing guide](https://docs.danswer.dev/resourcing).
...
<Info>
  ...
  compose -f docker-compose.dev.yml -p danswer-stack up -d --pull always`
...
`sudo docker logs danswer-stack-api_server-1 -f`; once you see a log for
