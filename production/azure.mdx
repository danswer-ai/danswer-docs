...
Using a Azure Virtual Machine is the recommended way to deploy Danswer on Azure. It is simple and should meet the performance needs of 90% of organizations looking to use Danswer. The steps are very similar to deploying on AWS EC2. Before we get started, make sure you have an account with Azure and have the necessary permissions to create a VM instance.
...
<Info>
  ...
  instead of the above. You can then access Danswer from the IP address from earlier.
</Info>
