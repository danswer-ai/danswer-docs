...
description: "Setup Danswer on AWS EC2"
---

Using EC2 (or an EC2 equivalent in your Cloud of choice) is the recommended way of deploying Danswer.
It is simple and should meet the performance needs of 90% of organizations looking to use Danswer.
...
[Contact Us](https://docs.danswer.dev/contact_us) page for more individual help.
...
Next, we need to preprare the instance so we can actually get Danswer up and running. To do this, you'll
