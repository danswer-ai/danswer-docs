...
3. In the application interface, paste your API key in the designated OpenAI credentials field.
...
3. In the application interface, paste your Cohere API key in the appropriate field.
...
3. In the application interface, enter your Voyage API key in the designated field.
...
6. In the application interface, upload the JSON key file in the Vertex AI credentials section.
