...
<img src="/images/connectors/discourse/discourse_1.gif" width="400" height="auto" alt="discourse_1" title="discourse_1" />

    4. Click **New API Key**, name it "Danswer". Select "All Users" for **User Level** and "Read-only" for **Scope**.

![discourse_2](/images/connectors/discourse/discourse_2.gif)

    5. Click **Save**. Copy the key and put it into Danswer.

![discourse_3](/images/connectors/discourse/discourse_3.gif)
...
![discourse_4](/images/connectors/discourse/discourse_4.gif)
