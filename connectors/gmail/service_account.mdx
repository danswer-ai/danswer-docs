...
### Indexing
    ...
    3. When using a Gmail Service Account, you must specify the email of the primary admin that you would like the service account to impersonate.
        - Ideally, this account should be an owner/admin of the Google Organization that owns the Gmail(s) you want to index.
