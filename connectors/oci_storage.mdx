...
5. Enter a friendly name for your key (e.g., "DanswerOCIConnector").
...
8. To find your tenancy's Object Storage namespace, click on the user icon in the top-right corner and select "Tenancy: [your tenancy name]".
9. In the tenancy details, you'll find the Object Storage namespace.
...
![API Keys](/images/connectors/blob/oci/danswer1.png)
...
![API Keys](/images/connectors/blob/oci/danswer2.png)
