...
![FreshdeskConnectorAuth](/images/connectors/freshdesk/freshdesk_2.png)
    ...
    5. Once you have the API key, you can use it (as well as your domain and password) to authorize your Danswer connector.
...
### Indexing
    ...
    6. Once you have created your connector Danswer will automatically begin indexing your tickets.