...
4. Set a name for the new user (e.g., "DanswerS3Connector") and click "Next".
5. Click "Attach policies directly" and search for "AmazonS3ReadOnlyAccess".
...
![Danswer S3 page 1](/images/connectors/blob/s3/danswer1.png)
...
![Danswer S3 page 2](/images/connectors/blob/s3/danswer2.png)
...
![Danswer S3 page 3](/images/connectors/blob/s3/danswer3.png)
