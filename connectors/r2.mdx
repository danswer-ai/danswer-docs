...
5. Give your token a name (e.g., "DanswerR2Connector") and select the appropriate permissions (Object Read only).
...
![Danswer page 1](/images/connectors/blob/r2/id.png)
...
![Danswer page 2](/images/connectors/blob/r2/danswer1.png)
...
![Danswer page 2](/images/connectors/blob/r2/danswer2.png)
