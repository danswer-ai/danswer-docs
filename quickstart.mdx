  ...
  the system requirements [here](https://docs.danswer.dev/resourcing).
    ...
    4. Bring up your docker engine and run:
        ...
        - This may take 15+ minutes depending on your internet speed.
            - Addditionally, once the images have been pulled / built, the initial startup of the `api_server` 
...
**This quickstart guide will index a publicly accessible website as this requires no additional authorization setup** 1. Navigate to the top right of Danswer's home screen and select **Admin Panel**
...
<Info>
  add `-v` at the end to delete the volumes (containing users and indexed
  documents){" "}
</Info>
